...
public class OscarReviewRepository {
    ...
    public List<OscarReview> findByUsername(String username) {
        return entityManager.createQuery(
                "SELECT r FROM OscarReview r WHERE r.username LIKE :userQuery", OscarReview.class)
                .setParameter("userQuery", username)
                .getResultList();
    }
