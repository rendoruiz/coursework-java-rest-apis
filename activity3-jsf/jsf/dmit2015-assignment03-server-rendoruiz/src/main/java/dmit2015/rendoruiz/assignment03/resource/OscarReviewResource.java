/**
 * read all
 curl -i -X GET http://localhost:8080/dmit2015-assignment03-server-rendoruiz/webapi/OscarReviews

 * read single oscar review
 curl -i -X GET http://localhost:8080/dmit2015-assignment03-server-rendoruiz/webapi/OscarReviews/3

 * new oscar review
 curl -i -X POST http://localhost:8080/dmit2015-assignment03-server-rendoruiz/webapi/OscarReviews/ \
 -d '{"category":"effects","nominee":"Affinity Photo","review":"Affinity","username":"affinityshill"}' \
 -H 'Content-Type:application/json'

 * update oscar review
 curl -i -X PUT http://localhost:8080/dmit2015-assignment03-server-rendoruiz/webapi/OscarReviews/4 \
 -d '{"id":4,"category":"effects","nominee":"Affinity Design","review":"Affinity Design is Better","username":"affinityshill"}' \
 -H 'Content-Type:application/json'

 * delete oscar review
 curl -i -X DELETE http://localhost:8080/dmit2015-assignment03-server-rendoruiz/webapi/OscarReviews/4
 */

package dmit2015.rendoruiz.assignment03.resource;
